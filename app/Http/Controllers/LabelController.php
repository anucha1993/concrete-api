...
class LabelController extends Controller
{
    ...
    public function productionOrderSerials(Request $request, int $id): JsonResponse
    {
        ...
        $query = Inventory::with(['product:id,product_code,name,category_id,length,length_unit,thickness,thickness_unit,width,steel_type,side_steel_type', 'product.category:id,name', 'location:id,name,code'])
